...
61 native Android captures. The new 1.2 screens appear first, followed by 1.1 and the original 1.0 walkthrough. Captures are added as each screen passes visual inspection. All visible people, records and bookings are fictional exhibition data.
...
<tr><td align="center"><img src="docs/screenshots/58-scheduled-truck-booking.png" width="230" alt="58 scheduled truck booking" /><br/><sub>scheduled truck booking</sub></td><td align="center"><img src="docs/screenshots/59-follow-camera.png" width="230" alt="59 follow camera" /><br/><sub>follow camera</sub></td><td align="center"><img src="docs/screenshots/60-lottie-logo-and-loading-skeletons.png" width="230" alt="60 lottie logo and loading skeletons" /><br/><sub>lottie logo and loading skeletons</sub></td></tr>
